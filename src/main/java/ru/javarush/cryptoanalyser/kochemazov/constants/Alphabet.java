...
public class Alphabet {
    ...
    private static final String RUSSIAN_ALPHABET_BIG = RUSSIAN_ALPHABET_SMALL.toUpperCase();
    private static final String ENGLISH_ALPHABET_SMALL = "abcdefghijklmnopqrstuvwxyz";
    private static final String ENGLISH_ALPHABET_BIG = ENGLISH_ALPHABET_SMALL.toUpperCase();
